...
Fayetteville, Arkansas 72701. \email{jd033@uark.edu}}
...
Now, the integral identity in \eqref{eq:identity} shows that if $f(x)$ with $x\geq 0$ is a density function, so is $g(x) = 2a f(|ax-b/x|)$ with $x > 0$.  The functions $f$ and $g$ are called mother and daughter density functions, respectively.  %\citet{chaubey2010reciprocal} provide a one-to-one correspondence between $f$ and $g$. 
